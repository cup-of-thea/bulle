    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:max-w-none">
            ...
            <dl class="mt-16 grid grid-cols-1 gap-0.5 overflow-hidden rounded-2xl text-center sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div class="flex flex-col bg-gray-400/5 p-8">
                    <dt class="text-sm font-semibold leading-6 text-gray-600">quitte la tech après 8 ans</dt>
                    <dd class="order-first text-3xl font-semibold tracking-tight text-gray-900">1 femme sur 2</dd>
                </div>
                <div class="flex flex-col bg-gray-400/5 p-8">
                    <dt class="text-sm font-semibold leading-6 text-gray-600">déclarent avoir été victimes de
                        comportements sexistes
                    </dt>
                    <dd class="order-first text-3xl font-semibold tracking-tight text-gray-900">46 %</dd>
                </div>
                <div class="flex flex-col bg-gray-400/5 p-8">
                    <dt class="text-sm font-semibold leading-6 text-gray-600">
                        de PIB supplémentaire estimés si la France était totalement paritaire
                    </dt>
